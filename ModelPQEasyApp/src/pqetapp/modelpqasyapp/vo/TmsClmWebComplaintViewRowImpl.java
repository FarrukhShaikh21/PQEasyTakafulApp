...
import pqetapp.modelpqasyapp.eo.TmsClmWebComplaintImpl;
...
public class TmsClmWebComplaintViewRowImpl extends ViewRowImpl implements TmsClmWebComplaintViewRow {
     ...
     */
    public TmsClmWebComplaintImpl getTmsClmWebComplaint() {
        return (TmsClmWebComplaintImpl) getEntity(ENTITY_TMSCLMWEBCOMPLAINT);
    }
    ...
    /**
     * Gets the attribute value for IMAGE_UPLOAD using the alias name ImageUpload.
     * @return the IMAGE_UPLOAD
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for IMAGE_UPLOAD using the alias name ImageUpload.
     * @param value value to set the IMAGE_UPLOAD
     */
